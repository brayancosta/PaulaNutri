...
- Fix: PHP error in class-cream-blog-multiple-select-dropdown-taxonomies.php
...
== 2.0.9 - 2 September, 2019 ==

- Issue with wp_body_open() fixed
- Issue of skip links fixed
- Gutentor, plugin recommended


== 2.0.8 - 8 May, 2019 ==

- Removed: Editor styles from admin folder


== 2.0.7 - 7 May, 2019 ==

- Fix: issue with masonry layout when lazy load was not enabled
